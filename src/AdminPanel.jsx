  ...
  return (
    <div className="min-h-screen bg-transparent text-neutral-900">
      ...
      <main className="max-w-7xl mx-auto px-4 py-5">
        ...
        {activeTab === "ventas" && <VentasTab carrito={carrito} clientes={clientes} perfumes={perfumes} accesorios={accesorios} onUpdateQty={updateCartQty} onRemove={removeFromCart} onCompletar={onCompletarVenta} ventas={ventas} onVerTicket={setTicketModal} addToCartFrasco={addToCartFrasco} addToCartDecant={addToCartDecant} addToCartAccesorio={addToCartAccesorio} guardarCliente={guardarCliente} />}
